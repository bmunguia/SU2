...
def main():
    ...
    cfd_flamelet_ch4_axi.test_vals = [
        -11.259626,
        -10.020810,
        -11.852795,
        -4.909152,
    ...
    cfd_flamelet_ch4_partial_premix.cfg_dir = (
    ...
    cfd_flamelet_ch4_partial_premix.test_vals = [
        -10.482722,
        -3.621055,
        -12.938151,
        -10.154391,
    ...
    invwedge_ap2.test_vals_aarch64 = [
        -0.982059,
        -1.506822,
        -16.735977,
        -17.063993,
    ...
    invwedge_msw.test_vals_aarch64 = [
        -1.212335,
        -1.737098,
        -18.299279,
        -18.626656,
    ...
    invwedge_lax.test_vals_aarch64 = [
        -0.877280,
        -1.402043,
        -32.000000,
        -32.000000,
    ...
    invwedge_ausm_m.test_vals_aarch64 = [
        -1.173033,
        -1.697796,
        -16.739586,
        -17.063491,
    ...
    invwedge_ss_inlet.test_vals_aarch64 = [
        -1.068592,
        -1.593355,
        -18.250183,
        -18.579524,
    ...
    channel.test_vals = [-2.305051, 3.237256, 0.125006, 0.154077]
    ...
    naca0012.test_vals = [-4.314738, -3.845428, 0.307738, 0.024670]
    ...
    wedge.test_iter = 20
    wedge.test_vals = [-3.573085, 2.150321, -0.249533, 0.043953]
    ...
    oneram6.test_vals = [-11.525271, -10.995902, 0.280800, 0.008623]
    ...
    fixedCL_naca0012.test_vals = [-3.919916, 1.592064, 0.300852, 0.019461]
    ...
    polar_naca0012.test_vals = [-1.206973, 4.234604, 0.013410, 0.073285]
    ...
    ramp.test_iter = 10
    ramp.test_vals = [-13.646937, -8.006398, -0.076277, 0.054839]
    ...
    ramp_msw.test_vals = [-7.5, -1.765, -0.077520, 0.054427]
    ramp_msw.tol = [0.03, 0.03, 0.00001, 0.00001]
    ...
    MFR_coupling.test_vals = [-2.1124e02, 1.5003e02, 2.0151e01]
    ...
    probe_performance_11.test_vals = [
        -6.290748,
        101020,
        101050,
        99123,
    ]  # RMS_DENSITY, probe1, probe6, probe11
    ...
    cylinder.test_vals = [-8.529918, -3.059339, 0.189560, 1.746170, 0.000000]
    ...
    cylinder_lowmach.test_vals = [-6.603373, -1.141590, -0.715787, -63.545748, 0.000000]
    ...
    rae2822_sa.test_vals = [-2.172705, -5.465982, 0.292927, 0.103369, 0.000000]
    ...
    rae2822_sst.test_vals = [-1.035662, 5.868036, 0.283073, 0.094756, 0.000000]
    ...
    rae2822_sst_sust.test_vals = [-2.542992, 5.868021, 0.283073, 0.094756]
    ...
    turb_flatplate.test_vals = [-4.879863, -7.464877, -0.187760, 0.016260]
    ...
    turb_flatplate_species.test_vals = [
        -4.548766,
        -1.476908,
        -1.980237,
        0.937064,
    ...
    turb_flatplate_CC_Wilcox.test_vals = [
        -1.169750,
        2.167973,
        1.488567,
        5.244807,
    ...
    turb_flatplate_CC_Sarkar.test_vals = [
        -1.169750,
        2.167973,
        1.488567,
        5.244807,
    ...
    turb_flatplate_sst_roughBCKnopp.test_vals = [
        -5.058634,
        -2.460850,
        -2.847064,
        0.447200,
    ...
    turb_flatplate_sst_roughBCAupoix.test_vals = [
        -5.278728,
        -2.302982,
        -2.890419,
        0.227585,
    ...
    turb_naca0012_sa.test_vals_aarch64 = [
        -12.037489,
        -16.376949,
        1.080346,
        0.018385,
    ...
    turb_naca0012_sst.test_vals_aarch64 = [
        -12.075620,
        -15.246688,
        -5.861276,
        1.070036,
    ...
    turb_naca0012_sst_sust.test_vals_aarch64 = [
        -12.073964,
        -14.836726,
        -5.732390,
        1.000050,
    ...
    turb_naca0012_sst_2003_Vm.test_vals = [
        -7.134118,
        -10.168739,
        -3.668709,
        1.060563,
    ...
    turb_naca0012_sst_1994_KLm.test_vals = [
        -7.142696,
        -10.390871,
        -3.701584,
        1.062164,
    ...
    axi_rans_air_nozzle_restart.test_vals = [
        -12.069349,
        -7.508309,
        -8.813361,
        -3.732852,
    ...
    axi_rans_air_nozzle_restart.test_vals_aarch64 = [
        -14.143310,
        -9.163287,
        -10.858232,
        -5.787715,
    ...
    inc_euler_naca0012.test_vals = [-5.984413, -5.104039, 0.523625, 0.008885]
    ...
    inc_nozzle.test_vals = [-5.594509, -4.878247, 0.005147, 0.139611]
    ...
    inc_lam_cylinder.test_vals = [-4.157264, -3.589125, -0.018681, 4.659302]
    ...
    inc_lam_sphere.test_vals = [-8.166398, -8.947226, 0.121003, 25.782690]
    ...
    sp_pipeSlice_3d_dp_hf_tp.cfg_dir = (
        "incomp_navierstokes/streamwise_periodic/pipeSlice_3d"
    )
    ...
    inc_heatTransfer_BC.cfg_dir = (
        "incomp_navierstokes/streamwise_periodic/chtPinArray_2d"
    )
    inc_heatTransfer_BC.cfg_file = "BC_HeatTransfer.cfg"
    inc_heatTransfer_BC.test_iter = 50
    inc_heatTransfer_BC.test_vals = [
        -8.904266,
        -7.745636,
        -8.064003,
        -1.079197,
    ...
    fem_ns_unsteady_cylinder_ader.test_vals = [
        -35.000000,
        -35.000000,
        -0.041003,
        1.391339,
    ...
    turbmod_sa_bsl_rae2822.test_vals = [
        -2.610446,
        0.335724,
        -0.118510,
        -5.463071,
    ...
    turbmod_sa_neg_rae2822.test_vals = [
        -1.345560,
        1.448328,
        1.208614,
        -0.846773,
    ...
    turbmod_sa_neg_rae2822.test_vals_aarch64 = [
        -1.345593,
        1.448310,
        1.208721,
        -0.846597,
    ...
    turbmod_sa_comp_rae2822.test_vals = [
        -2.610449,
        0.335720,
        -0.118515,
        -5.468848,
    ...
    turbmod_sa_edw_rae2822.test_vals = [
        -2.609968,
        0.336105,
        -0.118179,
        -6.022707,
    ...
    turbmod_sa_comp_edw_rae2822.test_vals = [
        -2.610041,
        0.336057,
        -0.118225,
        -6.023847,
    ...
    turbmod_sa_qcr_rae2822.test_vals = [
        -2.320855,
        0.512787,
        0.108026,
        -5.449178,
    ...
    schubauer_klebanoff_transition.test_vals = [
        -8.215651,
        -13.239431,
        0.000048,
        0.007983,
    ...
    contadj_oneram6.test_vals = [-12.069374, -12.632463, -1.086100, 0.007556]
    ...
    contadj_fixed_CL_naca0012.test_vals = [1.154889, -4.342907, -0.075177, -0.007496]
    ...
    contadj_ns_cylinder.test_vals = [-3.589714, -9.027143, 2.056700, -0.000000]
    ...
    turb_naca0012_1c.test_vals = [-4.982630, 1.343638, 0.664182, 0.009490]
    ...
    turb_naca0012_2c.test_vals = [-5.482693, 1.262634, 0.495712, -0.032734]
    ...
    turb_naca0012_3c.test_vals = [-5.583617, 1.229594, 0.463394, -0.035393]
    ...
    turb_naca0012_p1c1.test_vals = [-5.129475, 1.283940, 0.807012, 0.047519]
    ...
    turb_naca0012_p1c2.test_vals = [-5.553963, 1.234481, 0.604361, -0.008431]
    ...
    rot_naca0012.test_vals = [-1.302487, 4.220598, -0.002152, 0.124241]
    ...
    cavity.test_iter = 25
    cavity.test_vals = [-8.194578, -2.735580, 0.005612, -0.019805]
    ...
    spinning_cylinder.test_vals = [-7.716789, -2.257294, 2.054821, 1.660858]
    ...
    sine_gust.test_vals = [-1.977498, 3.481817, -0.010372, -0.005217]
    ...
    edge_VW.test_vals = [-3.178712, 3.023048, -0.000009, 0.000000]
    ...
    edge_PPR.test_vals = [-9.020461, -2.870274, -0.000034, 0.000000]
    ...
    coolprop_transportModel.test_vals = [
        -4.667122,
        -0.172865,
        4.687652,
        0.000000,
    ...
    datadriven_fluidModel.test_vals = [
        -6.283594,
        -3.253961,
        -4.172935,
        -0.949415,
    ...
    transonic_stator_restart.test_vals = [
        -4.363703,
        -2.480017,
        -2.079311,
        1.731709,
    ...
    transonic_stator_restart.test_vals_aarch64 = [
        -4.437809,
        -2.553049,
        -2.164729,
        1.657542,
    ...
    channel_3D.test_vals = [2.000000, 0.000000, 0.629098, 0.524941, 0.422526]
    ...
    bars_SST_2D.test_vals = [13.000000, -0.472766, -1.559919]
    ...
    rotating_cylinder_fea.test_vals = [
        -6.886145,
        -6.917148,
        -6.959634,
        23,
    ...
    rotating_cylinder_fea.test_vals_aarch64 = [
        -6.861939,
        -6.835539,
        -6.895498,
        22,
    ...
    nonlinear_plane_stress.test_vals = [
        -7.433449,
        -3.355607,
        -13.983863,
        162480,
    ...
    solid_periodic_pins.test_vals_aarch64 = [
        -15.879016,
        -14.569206,
        300.900000,
        425.320000,
    ...
    sp_pinArray_3d_cht_mf_hf_tp.cfg_dir = (
        "incomp_navierstokes/streamwise_periodic/chtPinArray_3d"
    )
    sp_pinArray_3d_cht_mf_hf_tp.cfg_file = "configMaster.cfg"
    sp_pinArray_3d_cht_mf_hf_tp.test_iter = 30
    sp_pinArray_3d_cht_mf_hf_tp.test_vals = [
        -1.116268,
        3.008626,
        -0.634287,
        -0.009805,
    ...
    pywrapper_naca0012.test_vals = [-7.755848, -7.082517, 0.335769, 0.023275]
    pywrapper_naca0012.command = TestCase.Command(
        "mpirun -np 2", "SU2_CFD.py", "--parallel -f"
    )
    ...
    pywrapper_turb_naca0012_sst.test_vals_aarch64 = [
        -12.075620,
        -15.246688,
        -5.861276,
        1.070036,
    ...
    pywrapper_turb_naca0012_sst.command = TestCase.Command(
        "mpirun -np 2", "SU2_CFD.py", "--parallel -f"
    )
    ...
    pywrapper_square_cylinder.command = TestCase.Command(
        "mpirun -np 2", "SU2_CFD.py", "--parallel -f"
    )
    ...
    pywrapper_aeroelastic.command = TestCase.Command(
        "mpirun -np 2", "SU2_CFD.py", "--parallel -f"
    )
    ...
    pywrapper_custom_fea_load.test_vals = [
        -7.262040,
        -4.945686,
        -14.163208,
        34,
    ...
    pywrapper_custom_fea_load.command = TestCase.Command(
    ...
    pywrapper_fsi2d.command = TestCase.Command(
        "mpirun -np 2", "SU2_CFD.py", "--nZone 2 --fsi True --parallel -f"
    )
    ...
    pywrapper_unsteadyFSI.test_vals = [
        0,
        31,
        5,
        58,
    ...
    pywrapper_unsteadyCHT.test_vals = [-1.614168, 2.259984, -0.005601, 0.129785]
    pywrapper_unsteadyCHT.command = TestCase.Command(
        "mpirun -np 2", "python", "launch_unsteady_CHT_FlatPlate.py --parallel -f"
    )
    ...
    pywrapper_rigidMotion.test_vals = [-1.614166, 2.255135, 0.350194, 0.089496]
    pywrapper_rigidMotion.command = TestCase.Command(
        "mpirun -np 2", "python", "launch_flatPlate_rigidMotion.py --parallel -f"
    )
    ...
    pywrapper_deformingBump.test_vals = [
        0.500000,
        0.000000,
        -2.556309,
        -1.270839,
    ...
    pywrapper_deformingBump.command = TestCase.Command(
        "mpirun -np 2", "python", "run.py"
    )
    ...
    pywrapper_buoyancy.test_vals_aarch64 = [
        -13.227985,
        -13.678478,
        -13.050758,
        -7.777151,
    ...
    pywrapper_Unst_Heat_Source.command = TestCase.Command(
    ...
    species2_primitiveVenturi_mixingmodel = TestCase(
        "species2_primitiveVenturi_mixingmodel"
    )
    species2_primitiveVenturi_mixingmodel.cfg_dir = (
        "species_transport/venturi_primitive_3species"
    )
    species2_primitiveVenturi_mixingmodel.cfg_file = (
        "species2_primitiveVenturi_mixingmodel.cfg"
    )
    species2_primitiveVenturi_mixingmodel.test_iter = 50
    species2_primitiveVenturi_mixingmodel.test_vals = [
        -5.735589,
        -4.564867,
        -4.669647,
        -5.794093,
    ...
    species2_primitiveVenturi_mixingmodel_boundedscalar = TestCase(
        "species2_primitiveVenturi_mixingmodel_boundedscalar"
    )
    species2_primitiveVenturi_mixingmodel_boundedscalar.cfg_dir = (
        "species_transport/venturi_primitive_3species"
    )
    species2_primitiveVenturi_mixingmodel_boundedscalar.cfg_file = (
        "species2_primitiveVenturi_mixingmodel_boundedscalar.cfg"
    )
    species2_primitiveVenturi_mixingmodel_boundedscalar.test_iter = 50
    species2_primitiveVenturi_mixingmodel_boundedscalar.test_vals = [
        -5.689670,
        -4.511504,
        -4.615493,
        -5.795204,
    ...
    species2_primitiveVenturi_mixingmodel_viscosity = TestCase(
        "species2_primitiveVenturi_mixingmodel_viscosity"
    )
    species2_primitiveVenturi_mixingmodel_viscosity.cfg_dir = (
        "species_transport/venturi_primitive_3species"
    )
    species2_primitiveVenturi_mixingmodel_viscosity.cfg_file = (
        "species2_primitiveVenturi_mixingmodel_viscosity.cfg"
    )
    species2_primitiveVenturi_mixingmodel_viscosity.test_iter = 50
    species2_primitiveVenturi_mixingmodel_viscosity.test_vals = [
        -5.239996,
        -3.625478,
        -3.874990,
        -7.535233,
    ...
    species2_primitiveVenturi_mixingmodel_heatcapacity_H2 = TestCase(
        "species2_primitiveVenturi_mixingmodel_heatcapacity_H2.cfg"
    )
    species2_primitiveVenturi_mixingmodel_heatcapacity_H2.cfg_dir = (
        "species_transport/venturi_primitive_3species"
    )
    species2_primitiveVenturi_mixingmodel_heatcapacity_H2.cfg_file = (
        "species2_primitiveVenturi_mixingmodel_heatcapacity_H2.cfg"
    )
    species2_primitiveVenturi_mixingmodel_heatcapacity_H2.test_iter = 50
    species2_primitiveVenturi_mixingmodel_heatcapacity_H2.test_vals = [
        -5.815955,
        -4.624944,
        -4.555357,
        -6.656244,
    ...
    species2_primitiveVenturi_mixingmodel_heatcapacity_H2_ND = TestCase(
        "species2_primitiveVenturi_mixingmodel_heatcapacity_H2_ND.cfg"
    )
    species2_primitiveVenturi_mixingmodel_heatcapacity_H2_ND.cfg_dir = (
        "species_transport/venturi_primitive_3species"
    )
    species2_primitiveVenturi_mixingmodel_heatcapacity_H2_ND.cfg_file = (
        "species2_primitiveVenturi_mixingmodel_heatcapacity_H2_ND.cfg"
    )
    species2_primitiveVenturi_mixingmodel_heatcapacity_H2_ND.test_iter = 50
    species2_primitiveVenturi_mixingmodel_heatcapacity_H2_ND.test_vals = [
        -5.404273,
        -4.918833,
        -4.841423,
        -7.647725,
    ...
    species2_primitiveVenturi_Lax_Friedrich = TestCase(
        "species2_primitiveVenturi_Lax_Friedrich.cfg"
    )
    species2_primitiveVenturi_Lax_Friedrich.cfg_dir = (
        "species_transport/venturi_primitive_3species"
    )
    species2_primitiveVenturi_Lax_Friedrich.cfg_file = (
        "species2_primitiveVenturi_Lax_Friedrich.cfg"
    )
    species2_primitiveVenturi_Lax_Friedrich.test_iter = 50
    species2_primitiveVenturi_Lax_Friedrich.test_vals = [
        -6.092441,
        -6.981653,
        -6.982959,
        -1.195023,
    ...
    species2_primitiveVenturi.test_vals = [
        -5.470699,
        -4.435379,
        -4.486544,
        -5.327925,
    ...
    species_primitiveVenturi_boundedscalar = TestCase(
        "species2_primitiveVenturi_bounded_scalar"
    )
    species_primitiveVenturi_boundedscalar.cfg_dir = (
        "species_transport/venturi_primitive_3species"
    )
    species_primitiveVenturi_boundedscalar.cfg_file = (
        "species2_primitiveVenturi_boundedscalar.cfg"
    )
    species_primitiveVenturi_boundedscalar.test_iter = 50
    species_primitiveVenturi_boundedscalar.test_vals = [
        -5.537734,
        -4.375388,
        -4.475128,
        -5.597904,
    ...
    species2_primitiveVenturi_mixingmodel_TURBULENT_MARKERS = TestCase(
        "species2_primitiveVenturi_mixingmodel_TURBULENT_MARKERS.cfg"
    )
    species2_primitiveVenturi_mixingmodel_TURBULENT_MARKERS.cfg_dir = (
        "species_transport/venturi_primitive_3species"
    )
    species2_primitiveVenturi_mixingmodel_TURBULENT_MARKERS.cfg_file = (
        "species2_primitiveVenturi_mixingmodel_TURBULENT_MARKERS.cfg"
    )
    species2_primitiveVenturi_mixingmodel_TURBULENT_MARKERS.test_iter = 50
    species2_primitiveVenturi_mixingmodel_TURBULENT_MARKERS.test_vals = [
        -4.847447,
        -1.922191,
        -1.947568,
        -0.716575,
    ...
    species3_primitiveVenturi_inletFile = TestCase(
        "species3_primitiveVenturi_inletFile"
    )
    species3_primitiveVenturi_inletFile.cfg_dir = (
        "species_transport/venturi_primitive_3species"
    )
    species3_primitiveVenturi_inletFile.cfg_file = (
        "species3_primitiveVenturi_inletFile.cfg"
    )
    species3_primitiveVenturi_inletFile.test_iter = 50
    species3_primitiveVenturi_inletFile.test_vals = [
        -5.541163,
        -4.505905,
        -4.557116,
        -5.398846,
    ...
    species3_primitiveVenturi_fluxvalue = TestCase(
        "species3_primitiveVenturi_fluxvalue"
    )
    species3_primitiveVenturi_fluxvalue.cfg_dir = (
        "species_transport/venturi_primitive_3species"
    )
    species3_primitiveVenturi_fluxvalue.cfg_file = (
        "species3_primitiveVenturi_flux_value.cfg"
    )
    species3_primitiveVenturi_fluxvalue.test_iter = 50
    species3_primitiveVenturi_fluxvalue.test_vals = [
        -4.563242,
        -5.504658,
        -0.861266,
        -5.822957,
    ...
    species_passive_val.test_vals_aarch64 = [
        -16.517744,
        -16.282420,
        -16.871663,
        -4.257599,
    ...
    species_active_transport_temp_limits = TestCase(
        "species_active_transport_temp_limits"
    )
    species_active_transport_temp_limits.cfg_dir = (
        "species_transport/passive_transport_validation"
    )
    species_active_transport_temp_limits.cfg_file = (
        "active_species_transport_temp_limits.cfg"
    )
    species_active_transport_temp_limits.test_iter = 50
    species_active_transport_temp_limits.test_vals = [
        -1.785041,
        -2.565628,
        2.460433,
        -3.188111,
    ...
    species_active_transport_temp_limits.test_vals_aarch64 = [
        -1.785041,
        -2.565628,
        2.460433,
        -3.188111,
    ...
    cfd_flamelet_ch4_cht.test_vals = [
        -9.824525,
        -8.913124,
        -9.862973,
        -11.271228,
    ...
    fd_sp_pinArray_cht_2d_dp_hf.cfg_dir = (
        "incomp_navierstokes/streamwise_periodic/chtPinArray_2d"
    )
    fd_sp_pinArray_cht_2d_dp_hf.cfg_file = "FD_configMaster.cfg"
    fd_sp_pinArray_cht_2d_dp_hf.test_iter = 100
    fd_sp_pinArray_cht_2d_dp_hf.command = TestCase.Command(
        exec="finite_differences.py", param="-z 2 -n 2 -f"
    )
    ...
    fd_sp_pinArray_cht_2d_dp_hf.reference_file_aarch64 = (
        "of_grad_findiff_aarch64.csv.ref"
    )
