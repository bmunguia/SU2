...
/*!
  ...
  */
   ...
   */
  string GetMesh_Itp_FileName(void) const {
    /*--- we keep the original Mesh_Itp_FileName  ---*/
    string meshFilename = Mesh_Itp_FileName;
   ...
   */
  string GetSolution_RefFileName(void) const {
    /*--- we keep the original Solution_RefFileName  ---*/
    string solutionFilename = Solution_RefFileName;
