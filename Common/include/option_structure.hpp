...
enum ENUM_FLOW_GRADIENT {
  ...
  L2_PROJECTION          = 4,   /*!< \brief Gradient/Hessian computation using lumped-mass L2-projection (simplicial elements only). */
};
...
enum class VERIFICATION_SOLUTION {
  ...
  SHOCK_TUBE,               /*!< \brief Sod shock tube. Exact solution of the unsteady Euler equations. */
...
static const MapType<std::string, VERIFICATION_SOLUTION> Verification_Solution_Map = {
  ...
  MakePair("SHOCK_TUBE",               VERIFICATION_SOLUTION::SHOCK_TUBE)
