...
# endif
  ...
  /*!\brief CYLINDER_VEL_PERTURB_FACTOR \n DESCRIPTION: Scaling factor applied to the freestream x-velocity in the perturbed zone of the perturbed-cylinder IC \n DEFAULT: 1.05 \ingroup Config*/
  addDoubleOption("CYLINDER_VEL_PERTURB_FACTOR", CylinderVelPerturbFactor, 1.05);
  /*!\brief CYLINDER_VEL_PERTURB_X0 \n DESCRIPTION: x-coordinate of the cylinder center for the perturbed-cylinder IC \n DEFAULT: 0.5 \ingroup Config*/
  addDoubleOption("CYLINDER_VEL_PERTURB_X0", CylinderVelPerturbX0, 0.5);
  /*!\brief CYLINDER_VEL_PERTURB_Y0 \n DESCRIPTION: y-coordinate of the cylinder center for the perturbed-cylinder IC \n DEFAULT: 0.0 \ingroup Config*/
 ...
 /* DESCRIPTION: default value for AIR */
  ...
  addStringOption("MESH_OUT_FILENAME", Mesh_Out_FileName, string("mesh_out"));
    /*!\brief MESH_ITP_FILENAME \n DESCRIPTION: Destination mesh file name. Used when interpolating a solution. \n DEFAULT: mesh_itp.su2 \ingroup Config*/
  addStringOption("MESH_ITP_FILENAME", Mesh_Itp_FileName, string("mesh_itp"));
  ...
  addStringOption("SOLUTION_REF_FILENAME", Solution_RefFileName, string("solution_ref"));
  ...
  addStringOption("SENSOR_ERROR_FILENAME", Sensor_Error_FileName, string("sensor_error"));
  /*!\brief METRIC_INTEGRAL_FILENAME
   *  \n DESCRIPTION: Output integral of metric tensor field for mesh adaptation sensor  \ingroup Config*/
  addStringOption("METRIC_INTEGRAL_FILENAME", Metric_Integral_FileName, string("metric_integral"));
...
void CConfig::SetOutput(SU2_COMPONENT val_software, unsigned short val_izone) {
  ...
  if (val_software == SU2_COMPONENT::SU2_CFD || val_software == SU2_COMPONENT::SU2_SOL ||
    ...
    if (Compute_Metric) {
      ...
      cout << endl;
      cout << "Hessian for adaptive metric: Green-Gauss." << endl;
      if (Normalize_Metric) {
